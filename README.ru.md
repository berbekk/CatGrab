...
Затем CatGrab откроет короткое знакомство: попробуйте кольцо, выберите сочетание, а на последних
страницах выдайте два доступа. Нажмите **Разрешить** и включите **CatGrab** в
каждом:
