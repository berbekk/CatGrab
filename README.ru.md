...
**[Скачать CatGrab.dmg](https://github.com/berbekk/CatGrab/releases/latest)** · [Сайт](https://berbekk.neocities.org/) · [English](README.md) · [История изменений](CHANGELOG.md)
...
- **Активные приложения.** Встроенное кольцо из программ, которыми вы пользовались последними, —
  радиальный <kbd>⌘</kbd><kbd>Tab</kbd>, который заодно переключает на нужный рабочий стол и
  разворачивает свёрнутые окна. По умолчанию шесть, можно до двенадцати или все.
...
- **Под себя:** секторы переставляются перетаскиванием, кольцо поворачивается <kbd>⌥</kbd>-перетаскиванием,
  чтобы каждый сектор стоял там, где ждёт рука. 24 цветовые темы для старта — палитры, градиенты,
  один цвет, — а дальше тонкая настройка цветов, насыщенности, стекла и иконок или свой цвет любому
  сектору. Кот в центре, который следит глазами за курсором. Настройки — в светлом или тёмном оформлении.
...
Затем CatGrab откроет короткое знакомство: попробуйте кольцо, выберите сочетание, посмотрите, как
кот переставляет секторы и поворачивает кольцо, а на последних страницах выдайте два доступа.
Нажмите **Разрешить** и включите **CatGrab** в
каждом:
