...
**[Скачать CatGrab.dmg](https://github.com/berbekk/CatGrab/releases/latest)** · [English](README.md) · [История изменений](CHANGELOG.md)
...
- **Быстрый выбор.** Пока меню открыто, нажмите цифру или букву на секторе.
- **Иконки откуда угодно:** SF Symbols, эмодзи, фавиконы сайтов, своя картинка или текст.
- **Под себя:** стеклянные секторы, цвета, размер, поворот, вынос иконок — и кот в центре, который
  следит глазами за курсором.
