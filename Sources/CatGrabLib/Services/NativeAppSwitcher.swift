...
/// CatGrab забирает эти сочетания себе — так же делает AltTab. Возвращаем при остановке tap'а и выходе.
enum NativeAppSwitcher {
    ...
    /// Отключает системные ⌘Tab / ⌘⇧Tab ровно для тех сочетаний, которые перехватывает CatGrab.
