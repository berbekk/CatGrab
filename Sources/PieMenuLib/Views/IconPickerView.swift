...
class FaviconDownloader {
    ...
    private init() {
        let dir = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("PieMenu/favicons")
    ...
    static func isFaviconCacheFilePath(_ absolutePath: String) -> Bool {
        absolutePath.contains("/PieMenu/favicons/")
    }
    ...
    private func tryLoad(domain: String, sources: [String], index: Int,
                          savePath: String, completion: @escaping (String) -> Void) {
...
struct IconPickerView: View {
    ...
    var launchAppBundleId: String? = nil
    ...
    @State private var sfCategoryIndex: Int? = nil
