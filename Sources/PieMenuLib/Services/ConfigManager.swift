...
extension Notification.Name {
    static let configurationDidChange = Notification.Name("PieMenu.configurationDidChange")
}
...
final class ConfigManager: ObservableObject {
    ...
    private init() {
        ...
        let appDir = appSupport.appendingPathComponent("PieMenu")
        do {
    ...
    private static func normalized(_ config: PieConfiguration) -> PieConfiguration {
        var c = config
        c.appMenuHotkey = .empty
        c.ensureRunningAppsMenuInvariant()
